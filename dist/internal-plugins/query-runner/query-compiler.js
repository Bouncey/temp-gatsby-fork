...
class Runner {
  ...
  async parseEverything() {
    ...
    let files = _glob2.default.sync(`${this.fragmentsDir}/**/*.+(t|j)s?(x)`);
    files = files.concat(_glob2.default.sync(`${this.baseDir}/**/*.+(t|j)s?(x)`));
  ...
  async write(nodes) {
    ...
    let compilerContext = new _GraphQLCompilerContext2.default(this.schema);
    try {
